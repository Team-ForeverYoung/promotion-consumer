...
public class KafkaConfigTemplate {
	...
	public ConsumerFactory<String, PromotionResultMessage> promotionResultConsumerFactory() {
		// JsonDeserializer 직접 생성 및 trustedPackages 설정
		JsonDeserializer<PromotionResultMessage> deserializer = new JsonDeserializer<>(PromotionResultMessage.class);
		deserializer.addTrustedPackages("com.java.promotionconsumer");
	...
	@Bean
	public ConcurrentKafkaListenerContainerFactory<String, PromotionResultMessage> promotionResultConsumerFactoryContainer() {
